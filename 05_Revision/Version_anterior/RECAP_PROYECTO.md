...
| Caída de tensión en NAC | peor caso **19,97 V** | ≥ 16 V ✔ |
...
| **Cableado NAC 16 AWG FPLR** | Caída peor caso **0,427 V** → 19,97 V ≥ 16 V, con casi 4 V de margen. El 14 AWG no lo exige el cálculo | **NEC cap. 9 Tabla 8** |
...
| **Cableado SLC 16 AWG** | 16 AWG admite hasta **4 875 ft**; el lazo mide ≈1 200 ft | **Fire•Lite doc. 51309** |
